...
run_custom_inference(
        data_source_path="/N/slate/jmelms/projects/FCN_dynamical_testing/data/initial_conditions/processed_ic_sets/testing_dynamic/",
        output_path="/N/slate/jmelms/projects/FCN_dynamical_testing/data/output/deleteme.nc",
        n_iters=1,
